...
const int numAsia = 5;
const int numAmericaNorteCentro = 5;
const int numAmericaSul = 5;
...
void popularAsia(string continente [numAsia]) {
    continente[0] = "CHINA";
    continente[1] = "RUSSIA";
    continente[2] = "JAPAO";
    continente[3] = "FILIPINAS";
    continente[4] = "INDIA";
}

void popularAmericaNorteCentro(string continente [numAmericaNorteCentro]) {
    continente[0] = "CHINA";
    continente[1] = "RUSSIA";
    continente[2] = "JAPAO";
    continente[3] = "FILIPINAS";
...
void popularAmericaSul(string continente [numAmericaSul]) {
    continente[0] = "CHINA";
    continente[1] = "RUSSIA";
    continente[2] = "JAPAO";
    continente[3] = "FILIPINAS";
...
int main() {
    ...
    string asia[numAfrica];
    string americaNorteCentro[numAfrica];
    string americaSul[numAfrica];
